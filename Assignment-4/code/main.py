...
prob_E_And_F = float(len(E.intersection(F))/len(S))
...
prob_E_And_G = float(len(E.intersection(G))/len(S))
...
# (iii)
A = E.union(F)
prob_A_and_G = float(len(A.intersection(G))/len(S))
...
B = E.intersection(F)
prob_B_and_G = float(len(B.intersection(G))/len(S))
